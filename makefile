...
main: ./src/*.cpp
	g++ $(COMPILER_FLAGS) $(SRC_DIRS) -I$(SDL_INCLUDE) -L$(SDL_LIBRARY) $(LINKER_FLAGS) -I$(SDL_IMAGE_INCLUDE) -L$(SDL_IMAGE_LIBRARY) -o NES_EMU
logging:
	g++ $(COMPILER_FLAGS) $(LOGGING_FLAGS) $(SRC_DIRS) -I$(SDL_INCLUDE) -L$(SDL_LIBRARY) $(LINKER_FLAGS) -I$(SDL_IMAGE_INCLUDE) -L$(SDL_IMAGE_LIBRARY) -o NES_EMU